...
<html>
	...
	<body>
		...
		<div>
			<ul>
			    ...
			    <li><h1 id="title"> AIR SPACE </h1></li>
			...
			<div class="welcome_text text-center">
			  <section class="text-center"><br>Welcome to Airspace</section>
			  <br>
			  ...
			  <div class="col-3" id="dialog-box">Book ticket<i class='fas fa-plane-departure' style='font-size:36px'></i></div>
			  </div>
			</div>
	...
	All copyrights reserved @airspace
	</footer>
</html>